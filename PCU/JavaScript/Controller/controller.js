app.controller('Prescription', ['$scope','$window', function($scope,$window) {
    $scope.redirectToGoogle = function () {
        $window.open('http://localhost:63342/PCU/Interface/Prescription.html');
    };
}]);

app.controller('LabTest', ['$scope','$window', function($scope,$window) {
    $scope.redirectToGoogle = function () {
        $window.open('http://localhost:63342/PCU/Interface/LabTest.html');
    };
}]);

app.controller('ManagePrescription', ['$scope','$window','$http', function($scope,$window) {
    $scope.redirectToGoogle = function () {
        $window.open('http://localhost:63342/PCU/Interface/Pres&Labs/ManagePrescription.html');
...
app.controller('ManageLabTest', ['$scope','$window', function($scope,$window) {
    $scope.redirectToGoogle = function () {
        $window.open('http://localhost:63342/PCU/Interface/Pres&Labs/ManageLabTest.html');
    };
}]);

app.controller('SearchPrescription', ['$scope','$window', function($scope,$window) {
    $scope.redirectToGoogle = function () {
        $window.open('http://localhost:63342/PCU/Interface/Pres&Labs/SearchPrescription.html');
    };
}]);

app.controller('SearchLabTest', ['$scope','$window', function($scope,$window) {
    $scope.redirectToGoogle = function () {
        $window.open('http://localhost:63342/PCU/Interface/Pres&Labs/SearchLabTest.html');
    };
}]);

app.controller('nonCritPatient', ['$scope','$window', function($scope,$window) {
    $scope.redirectToGoogle = function () {
        $window.open('http://localhost:63342/PCU/Interface/PatientManage.html');
    };
}]);

app.controller('CheckHistory', ['$scope','$window', function($scope,$window) {
    $scope.redirectToGoogle = function () {
        $window.open('http://localhost:63342/PCU/Interface/NonCritical/checkHistory.html');
    };
}]);

app.controller('NonCritical', ['$scope','$window', function($scope,$window) {
    $scope.redirectToGoogle = function () {
        $window.open('http://localhost:63342/PCU/Interface/NonCritical/Non-Critical.html');
    };
}]);

app.controller('AssignDoc', ['$scope','$window', function($scope,$window) {
    $scope.redirectToGoogle = function () {
        $window.open('http://localhost:63342/PCU/Interface/NonCritical/AssignDoc.html');
    };
}]);

app.controller('AssignWord', ['$scope','$window', function($scope,$window) {
    $scope.redirectToGoogle = function () {
        $window.open('http://localhost:63342/PCU/Interface/NonCritical/ManageWard.html');
    };
}]);

app.controller('NewCheck', ['$scope','$window', function($scope,$window) {
    $scope.redirectToGoogle = function () {
        $window.open('http://localhost:63342/PCU/Interface/NonCritical/NewCheck.html');
    };
}]);

app.controller('CriticalHome', ['$scope','$window', function($scope,$window) {
    $scope.redirectToGoogle = function () {
        $window.open('http://localhost:63342/PCU/Interface/Critical/CriticalHome.html');
    };
}]);

app.controller('SearchPatient', ['$scope','$window', function($scope,$window) {
    $scope.redirectToGoogle = function () {
        $window.open('http://localhost:63342/PCU/Interface/Critical/SearchPatient.html');
    };
...
app.controller('ManageWardDetails', ['$scope','$window', function($scope,$window) {
    $scope.redirectToGoogle = function () {
        $window.open('http://localhost:63342/PCU/Interface/Critical/ManageWardDetails.html');
    };
...
app.controller('Reg-Admin', ['$scope','$window', function($scope,$window) {
    $scope.redirectToGoogle = function () {
        $window.open('http://localhost:63342/PCU/Interface/Registration/Admission-Registration.html');
    };
}]);

app.controller('Admission', ['$scope','$window', function($scope,$window) {
    $scope.redirectToGoogle = function () {
        $window.open('http://localhost:63342/PCU/Interface/Registration/admission.html');
